...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getInfo: function getInfo() {
      ...
      var that = this;
      __WEBPACK_IMPORTED_MODULE_1__utils_request__["a" /* default */].get("/index/user/info").then(function (res) {
        if (res.data.success) {
  ...
  onPullDownRefresh: function onPullDownRefresh() {
    ...
    setTimeout(function () {
      __WEBPACK_IMPORTED_MODULE_1__utils_request__["a" /* default */].get("/wechat/infor").then(function (res) {
        if (res.data.status == "success") {
          _this4.data = res.data.data;
          __WEBPACK_IMPORTED_MODULE_0__utils_global__["a" /* default */].commit("setBalance", _this4.data.accountBalance);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('p', [_vm._v("我有任务")])], 1)])]), _vm._v(" "), _vm._m(0), _vm._v(" "), (_vm.spinShow) ? _c('i-spin', {
    attrs: {
      "size": "large",
      "fix": "",
      "custom": "",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_49ad94e4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(17);
var disposed = false
